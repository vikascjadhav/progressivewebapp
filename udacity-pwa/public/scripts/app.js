...
(function() {
  ...
  app.saveSelectedSCities= function() {
  ...
  app.updateForecastCard = function(data) {
    ...
    var dateOnCardEl = card.querySelector('.date');
    if (dateOnCardEl.getAttribute('data-dt') >= data.currently.time) {
      return;
    }
